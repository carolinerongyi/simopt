...
class Ambulance(Auto_Model):
    ...
    def __init__(self, fixed_factors={}):
        ...
        self.specifications = {
            ...
            # },
            "base0": {
                "description": "coordinates of ambulance base 0",
                "datatype": tuple,
                "default": (0,0)
            },
            "base1": {
                "description": "coordinates of ambulance base 1",
                "datatype": tuple,
                "default": (0,0)
            },
            # "x1": {
        ...
        self.check_factor_list = {
            "interarrival_mean": self.check_interarrival_mean,
            "scene_mean": self.check_scene_mean,
            "sim_length": self.check_sim_length,
            "warmup": self.check_warmup,
            "amb_speed" : self.check_amb_speed,
            "num_bases" :self.check_num_bases,
            # "x0" : self.check_x0,
            # "y0": self.check_y0,
            # "x1" : self.check_x1,
            # "y1": self.check_y1,
            "base0": self.check_base0,
            "base1": self.check_base1
        }
    ...
    def check_interarrival_mean(self):
        return self.factors["interarrival_mean"] > 0
    def check_scene_mean(self):
        return self.factors["scene_mean"] > 0
    def check_sim_length(self):
        return self.factors["sim_length"] > 0
    def check_warmup(self):
        return self.factors["warmup"] >= 0
    def check_amb_speed(self):
        return self.factors["amb_speed"] > 0
    def check_num_bases(self):
        return self.factors["num_bases"] > 0
    # def check_x0(self):
    #     return self.factors["x0"] >= 0
    # def check_y0(self):
    #     return self.factors["y0"] >= 0
    # def check_x1(self):
    #     return self.factors["x1"] >= 0
    # def check_y1(self):
    #     return self.factors["y1"] >= 0  
    def check_base0(self):
        return self.factors["base0"][1]>= 0 and self.factors["base0"][0]>= 0
    def check_base1(self):
        return self.factors["base1"][1]>= 0 and self.factors["base1"][0]>= 0
    ...
    def inner_replicate(self, diff_factors, rng_list, response_names):
        ...
        # ##hagen changed these below for non altered factor list
        # x = [factors['base0'][0], factors['base1'][0]]
        # y = [factors['base0'][1], factors['base1'][1]]
        x = [factors['base0_x'], factors['base1_x']]
        y = [factors['base0_y'], factors['base1_y']]
        # print(factors['base0'])
        # x = [factors['base0'][0], 0]
        # y = [factors['base0'], factors['base1']]
